 ...
 */
public class FragmentTherapy extends Fragment {

  private WebView therapyWebView;
  private String startingURL;

  public static FragmentTherapy newInstance(String startingLink) {
    FragmentTherapy therapyFrag = new FragmentTherapy();
